...
- **Backend:** Spring Boot 3.5 + Kotlin. JPA + MariaDB (port 3307 host). **Flyway owns the schema** (latest V27); Hibernate `ddl-auto: validate` (asserts entities match the migrated schema, never mutates it).
